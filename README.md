...
![登录注册](./case_show/登录注册.jpg)

### 4.提交订单

![提交订单](./case_show/提交订单.png)

### 5.搜索商品

![搜索时序图](./case_show/搜索时序图.png)

### 6.订单查询

![订单查询](./case_show/订单查询.png)

### 7.上传商品

![上传商品](./case_show/上传商品.png)

### 8.后台订单管理

![后台订单管理](./case_show/后台订单管理.png)
...
至此，本农产品商城小程序的（1）用例说明（2）产品实现说明（3）代码编写已全部完成，可以通过二维码进行体验，正式版本正在审核上线中，敬请期待！
